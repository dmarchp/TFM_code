...
def getComSizesAllTraj(N, arena_r, interac_r, loops, maxCicles):
    ...
    for i in range(1,existingFiles+1):
        ...
        for cicle in cicles:
            ...
            giantCompsDic['trajID'].extend(i), giantCompsDic['cicleID'].extend(cicle), giantCompsDic['comSizes'].extend(gc)
