...
if __name__ == '__main__':
    ...
    # for ir in [3.5, 3.75, 4.0, 4.25, 4.5, 4.75, 5.0, 6.0, 7.0, 8.0, 9.0]:
    ...
    configs_to_contacts(40, 18.5, 3.4, 800, maxFiles=mFiles, jumpTrajConfigs=5)
    contacts_to_contactsInt(40, 18.5, 3.4, 800, maxFiles=mFiles)
    # configs_to_contacts(45, 18.5, 3.4, 800, maxFiles=mFiles, jumpTrajConfigs=5)
    # contacts_to_contactsInt(45, 18.5, 3.4, 800, maxFiles=mFiles)