...
if __name__ == '__main__':
    ...
    auxFname = f'sols_pis_{pichain}_qs_{qchain}_l_{l}_lci_{lci}_ci_kwargs_{ci_kwargs_chain}.dat'
    ...
    solsdf = pd.read_csv(f'{auxFname}', names=['f0', 'f1', 'f2'], header=None, sep='\s+')
