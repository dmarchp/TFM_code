...
paramCombs = [
    ...
    [(0.2, 0.2), (9.0, 10.0), 0.1, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.2, 0.2), (9.0, 10.0), 0.15, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.2, 0.2), (9.0, 10.0), 0.2, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.2, 0.2), (9.0, 10.0), 0.3, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.2, 0.2), (9.0, 10.0), 0.45, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    # [(0.2, 0.2), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'], # done... 3793 6207
    # [(0.2, 0.2), (9.0, 10.0), 0.75, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'], #done... 3949 6051
    # [(0.2, 0.2), (9.0, 10.0), 0.9, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'], # done ... 4282 5718
