...
def get_win_probs(pis, qs, l, lci, ci_kwargs, N, maxTime, Nrea, ic, mpID):
    ...
    simCall = f'python LES_model_Gill_numba.py -pis {pichain_exec} -qs {qchain_exec} -l {l} -lci {lci} -N {N} -maxTime {maxTime} -Nrea {Nrea} -ic {ic}'
    simCall += f' -ci_kwargs {ci_kwargs_chainExec} --dontSaveTimeEvo --countWinner > winprobs{mpID}.dat'
...
paramCombs = [
    ...
    [(0.1, 0.1), (3.0, 10.0), 0.1, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.2, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.3, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.45, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.6, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.75, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.9, 1.0, (1, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],

    [(0.1, 0.1), (3.0, 10.0), 0.1, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.2, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.3, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.45, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.6, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.75, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.9, 1.0, (2, 0.3, 10.0 ), 1000, 100.0, 1000, 'N'],

    [(0.1, 0.1), (3.0, 10.0), 0.1, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.2, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.3, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.45, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.6, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.75, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (3.0, 10.0), 0.9, 1.0, (2, 0.3, 500.0 ), 1000, 100.0, 1000, 'N'],
