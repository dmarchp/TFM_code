...
paramCombs = [
    ...
    [(0.1, 0.1), (9.0, 10.0), 0.1, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.2, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.3, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.45, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.75, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.9, 1.0, (1, 0.3, 15.0), 1000, 100.0, 1000, 'N'],
