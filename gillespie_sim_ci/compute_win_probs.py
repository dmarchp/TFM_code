...
paramCombs = [
    ...
    # to do, but take so much time, better do it in depaula
    # [(0.2, 0.2), (9.0, 10.0), 0.45, 1.0, (0, ), 1000, 100.0, 10000, 'N'],
    # [(0.2, 0.2), (9.0, 10.0), 0.6, 1.0, (0, ), 1000, 100.0, 10000, 'N'],
    # [(0.2, 0.2), (9.0, 10.0), 0.75, 1.0, (0, ), 1000, 100.0, 10000, 'N'],
    # [(0.2, 0.2), (9.0, 10.0), 0.9, 1.0, (0, ), 1000, 100.0, 10000, 'N'],
]
