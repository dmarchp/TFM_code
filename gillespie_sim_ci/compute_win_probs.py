...
paramCombs = [
    ...
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.1, 1.0,  (2, 0.3, 500.0), 1000, 90.0, 10, 'N'], 
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.2, 1.0,  (2, 0.3, 500.0), 1000, 65.0, 1000, 'N'],
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.3, 1.0,  (2, 0.3, 500.0), 1000, 50.0, 1000, 'N'], 
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.45, 1.0,  (2, 0.3, 500.0), 1000, 40.0, 1000, 'N'],
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.6, 1.0,  (2, 0.3, 500.0), 1000, 35.0, 1000, 'N'],
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.75, 1.0,  (2, 0.3, 500.0), 1000, 35.0, 1000, 'N'],
    [(0.1, 0.1, 0.1), (8.0, 9.0, 10.0), 0.9, 1.0,  (2, 0.3, 500.0), 1000, 30.0, 1000, 'N'],
