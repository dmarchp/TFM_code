...
paramCombs = [
    ...
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (0, ), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (1, 0.3, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 1.0, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N']
]
