...
paramCombs = [
    ...
    # quality 5 make sure they have two fixed points...
    [(0.1, 0.1), (5.0, 10.0), 0.45, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (5.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (5.0, 10.0), 0.75, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.1, 0.1), (5.0, 10.0), 0.9, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],

    [(0.2, 0.2), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],

    [(0.15, 0.15), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.15, 0.15), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.15, 0.15), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N'],
    [(0.15, 0.15), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N'],

    [(0.25, 0.25), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.25, 0.25), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.25, 0.25), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N'],
    [(0.25, 0.25), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N'],

    [(0.4, 0.4), (9.0, 10.0), 0.6, 1.0, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.4, 0.4), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N'],
    [(0.4, 0.4), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N'],
    [(0.4, 0.4), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N'],
