...
execParams = [
    ...
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (0, ), 1000, 100.0, 100, 'N'],
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 10.0), 1000, 100.0, 100, 'N'],
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 10.0), 1000, 100.0, 100, 'N'],
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (1, 0.3, 500.0), 1000, 100.0, 100, 'N'],
    [(0.3, 0.3), (9.0, 10.0), 0.6, 1.0, (2, 0.3, 500.0), 1000, 100.0, 100, 'N'],
