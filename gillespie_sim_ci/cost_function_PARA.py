...
execParams = [
    ...
    [(0.1, 0.1), (9.0, 10.0), 0.1, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.15, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.2, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.3, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.45, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.6, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.75, 0.0, (0,), 1000, 400.0, 100, 'N'],
    [(0.1, 0.1), (9.0, 10.0), 0.9, 0.0, (0,), 1000, 400.0, 100, 'N'],
