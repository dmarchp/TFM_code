...
if getPCname() == 'depaula.upc.es':
    froute = '/Users/david/Desktop/Uni_code/TFM_code/network_models_sim/'
else:
    froute = "/home/david/Desktop/Uni_code/TFM_code/network_models_sim/"
fin_file = 'input_template_nwk.txt'
fex_file = 'main.x'
f_file = 'main_nwk.f90'
