...
paramCombs = [
    ...
    [(1.0, 1.05), 1, 0.05, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.10, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.15, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.20, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.25, (1, 0.5, 10.0), 1000, 100.0, 10000, 'N', True],

    [(1.0, 1.05), 1, 0.10, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.20, (2, 0.3, 10.0), 1000, 100.0, 10000, 'N', True],

    [(1.0, 1.05), 1, 0.10, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.20, (1, 0.3, 500.0), 1000, 100.0, 10000, 'N', True],

    [(1.0, 1.05), 1, 0.10, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N', True],
    [(1.0, 1.05), 1, 0.20, (2, 0.3, 500.0), 1000, 100.0, 10000, 'N', True],
]
